...
• SDA\_PIN         16
• SCL\_PIN         17
• POWER\_VIN\_PIN       A0 // A2
• POWER\_BAT\_PIN       A0 // A3
...
zapínání / vypínání debug informace na seriovem portu
#define SERIAL\_DEBUG 1

default konfigurace wifi
• WIFI\_SSID       "Free Hotel Olympia"
• WIFI\_PASS       ""

default konfigurace MQTT
• MQTT\_SERVER     "mqtt3.thingspeak.com"
• MQTT\_PORT       1883
• CHANNEL\_ID\_1    "3389737"
• CHANNEL\_ID\_2    "3394344"
• CHANNEL\_ID\_3    "3394347"

tlak vzduchu
• SEALEVELPRESSURE\_HPA 1013.25f
...
délka fronty SD logger
#define SD\_QUEUE\_LENGTH                4

telemetrie napájení
• POWER\_VIN\_RTOP      100000.0f
• POWER\_VIN\_RBOTTOM   22000.0f
• POWER\_BAT\_RTOP      100000.0f
• POWER\_BAT\_RBOTTOM   22000.0f
...
Předpokládá se, ze minimalne 3 hodnoty budou venovany na monitorovani
napájení (  probe Vin , Logger Vin, Logger VsenseAC )
...
Pokud tato podmínka není splněna, funkce vrátí hodnotu

NaN

(neplatný výsledek).

#### 4. Logarithmic (CAL_LOG)
...
Pokud cType obsahuje neznámou hodnotu, kalibrace se neprovede a funkce vrátí původní vstupní hodnotu:

y = x
Chování funkce

Funkce calibrate() vrací jednu z následujících hodnot:

Situace	Návratová hodnota
Platná kalibrace	Vypočtená hodnota podle zvolené rovnice
Hodnota mimo definovaný rozsah	0.0
Neplatný argument mocniny nebo logaritmu	NaN
Neznámý typ kalibrace	Původní hodnota x
Neexistující konfigurace (nullptr)	Původní hodnota x
Příklad
...
y = 3.5 + 1.2·20 + 0.05·20²
  = 47.5

Pokud bude vstup například
...
protože hodnota leží mimo definovaný rozsah kalibrace.